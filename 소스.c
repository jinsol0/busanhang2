/*
// 1-1
: 부산헹1 코드를 함수들로 정리했습니다.

// 1-2
: 유효한 값이 입력될 때까지 무한 반복되게 코딩했고,
  마동석의 체력, 시민과 마동석의 어그로를 추가하였습니다.
  Sleep()을 삭제하고 마동석의 움직임이나 액션을 입력받는 것으로 변경하였습니다.

// 1-3
: 시민, 좀비, 마동석의 이동 규칙과 예외 처리를 함수로 만들어
  모두 정확히 처리하도록 코딩하였습니다.

// 1-4
: 시민, 좀비, 마동석의 행동과 예외 처리를 함수로 만들어 제대로
  행동하고 종료될 수 있도록 코딩하였습니다.

// 1-5
: 부산헹3 - BONUS는 만들지 못했습니다.

==> 부산헹3을 제외하곤 부산헹2는 모두 구동되도록 만들었습니다.
*/
